                ...
                {variants.map((variant, index) => (
                  <div key={index} className="bg-background/50 rounded-xl p-6 border border-border animate-fade-in-up">
                    <div className="flex justify-between items-center mb-6">
                      <div className="flex items-center space-x-3">
                        <div className="w-6 h-6 bg-gradient-to-r from-purple-500 to-indigo-600 rounded-full flex items-center justify-center text-black text-sm font-bold">
                          {index + 1}
                        </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                    {uploadedImages.map((upload, index) => (
                      <div key={index} className="relative group">
                        ...
                        {index === 0 && (
                          <span className="absolute top-2 left-2 bg-gradient-to-r from-emerald-500 to-teal-600 text-black text-xs px-2 py-1 rounded-full font-semibold shadow-lg">
                            Primary
                          </span>
                        )}
                      </div>
