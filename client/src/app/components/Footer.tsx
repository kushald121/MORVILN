          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 lg:gap-8">
            ...
            <div className="flex flex-col justify-between h-full order-3 lg:order-1">
              ...
              <div className="mt-auto">
                ...
                <ul className="flex gap-8 mb-8 justify-center lg:justify-start">
                  ...
                  {/* Instagram */}
                  <li>
                    <a href="https://www.instagram.com" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-white hover:scale-110 transform transition duration-300">
                  ...
                  {/* Github */}
                  <li>
                    <a href="https://github.com" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-white hover:scale-110 transform transition duration-300">
            ...
            <div className="flex flex-col items-center order-2">
              ...
              <nav className="flex flex-col space-y-4 text-center">
                ...
                <a href="/helpfullpage/refundpolicy" className="text-gray-300 hover:text-white hover:underline transition text-lg">
                  Refund Policy
                </a>
                <a href="/helpfullpage/privacypolicy" className="text-gray-300 hover:text-white hover:underline transition text-lg">
                  Privacy Policy
                </a>
                <a href="/helpfullpage/terms&conditions/" className="text-gray-300 hover:text-white hover:underline transition text-lg">
                  Terms of Service
                </a>
                <a href="/contact" className="text-gray-300 hover:text-white hover:underline transition text-lg">
                  Contact Us
                </a>
              </nav>
            </div>
