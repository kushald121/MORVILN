      ...
      <main className="flex-grow">
        ...
        <div className="relative isolate overflow-hidden pt-16 sm:pt-24 lg:pt-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
            <div className="mx-auto max-w-4xl">
              ...
              <h1 className="mt-2 text-4xl font-bold tracking-tight text-foreground sm:text-6xl text-gradient">
                Accessibility for Everyone
              </h1>
              <p className="mt-6 text-xl leading-8 text-muted-foreground">
                We are dedicated to ensuring our digital storefront is welcoming
        ...
        <div className="mx-auto mt-24 max-w-7xl px-6 sm:mt-32 lg:px-8">
          <div className="mx-auto max-w-2xl lg:max-w-none">
            <div className="lg:grid lg:grid-cols-2 lg:items-start lg:gap-x-8">
              <div className="text-base leading-7 text-foreground lg:pt-2">
                ...
                <p className="mt-6 text-lg leading-8 text-muted-foreground">
                  ...
                  Wide Web Consortiums (W3C) Web Content Accessibility
        ...
        <div className="mx-auto mt-24 max-w-7xl px-6 sm:mt-32 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 max-w-2xl mx-auto text-lg leading-8 text-muted-foreground">
              We have built several key features into our platform to ensure a
              smooth journey.
            </p>
          </div>
        ...
        <div className="relative mt-24 sm:mt-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="relative isolate overflow-hidden bg-card px-6 py-24 text-center shadow-2xl rounded-2xl sm:px-16 border border-border">
              <h2 className="mx-auto max-w-2xl text-3xl font-bold tracking-tight text-card-foreground sm:text-4xl">
                Help us do even better.
              </h2>
              <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-muted-foreground">
                Your feedback is invaluable. If you encountered any issue or
                have a suggestion, please dont hesitate to reach out.
              </p>
              <div className="mt-10 flex items-center justify-center gap-x-6">
                <a
                  href="mailto:accessibility@yourcompany.com"
                  className="inline-flex items-center justify-center rounded-md bg-primary px-5 py-3 text-base font-semibold text-primary-foreground shadow-sm hover:bg-primary/90  focus-visible:outline-offset-2 focus-visible:outline-ring transition-colors duration-300"
                >
                  <MessageSquare
