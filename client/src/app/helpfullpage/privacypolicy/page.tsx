  ...
  return (
    <div className="border-b border-gray-200 dark:border-border">
      <dt>
        <button
          onClick={() => onToggle(id)}
          className="flex w-full items-center justify-between py-6 text-left text-gray-900 dark:text-foreground"
        >
          <div className="flex items-center gap-x-4">
            <Icon className="h-7 w-7 text-blue-600 dark:text-primary" aria-hidden="true" />
            <span className="text-lg font-semibold leading-7">{title}</span>
          </div>
          <span className="ml-6 flex h-7 items-center">
            <ChevronDown
              className={`h-6 w-6 transform text-gray-500 dark:text-muted-foreground transition-transform duration-300 ${
      ...
      >
        <div className="prose prose-gray dark:prose-slate max-w-none text-gray-600 dark:text-muted-foreground prose-strong:text-gray-900 dark:prose-strong:text-foreground prose-a:text-blue-600 dark:prose-a:text-primary hover:prose-a:text-blue-700 dark:hover:prose-a:text-primary/80">
          {children}
        </div>
      </dd>
    </div>
      ...
      <main className="flex-grow">
        ...
        <div className="relative isolate overflow-hidden pt-24 pb-16 sm:pt-32 sm:pb-24">
          <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 dark:text-foreground sm:text-6xl">
              Your Privacy, Protected
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-muted-foreground max-w-2xl mx-auto">
          ...
          <div className="absolute inset-x-0 top-0 -z-10 flex transform-gpu justify-center overflow-hidden blur-3xl">
            <div
              className="aspect-[1500/1036] w-[90rem] flex-none bg-gradient-to-r from-blue-400 to-cyan-400 dark:from-[#00c4ff] dark:to-[#34d399] opacity-25"
              style={{
                clipPath:
        ...
        <div className="mx-auto my-24 max-w-4xl px-6 sm:my-32 lg:px-8">
          <div className="rounded-2xl bg-gray-50 dark:bg-card p-8 ring-1 ring-gray-200 dark:ring-border shadow-xl border border-gray-200 dark:border-border">
            <h2 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-card-foreground text-center">
              Have Questions?
            </h2>
            <p className="mt-2 text-center text-gray-600 dark:text-muted-foreground">
              If you&rsquo;d like to exercise your rights or have questions about our
              privacy practices, please contact us.
            </p>
            <div className="mt-8 space-y-5 text-gray-600 dark:text-muted-foreground">
              <div className="flex items-center gap-4">
                <Phone className="h-6 w-6 text-blue-600 dark:text-primary flex-shrink-0" />
                <span>+91 315 2439846</span>
              </div>
              <div className="flex items-center gap-4">
                <Mail className="h-6 w-6 text-blue-600 dark:text-primary flex-shrink-0" />
                <span>rachnacollective@gmail.com</span>
              </div>
              <div className="flex items-start gap-4">
                <MapPin className="h-6 w-6 text-blue-600 dark:text-primary flex-shrink-0 mt-1" />
                <span>
