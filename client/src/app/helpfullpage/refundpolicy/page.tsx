...
const AccordionItem: React.FC<AccordionItemProps> = ({ id, title, icon: Icon, children, isOpen, onToggle }) => {
  return (
...
const RefundPolicy = () => {
  const [openId, setOpenId] = useState<string | null>('how-to-return'); // Keep the most important section open by default
      ...
      <main className="flex-grow">
        ...
        <div className="relative isolate overflow-hidden pt-24 pb-16 sm:pt-32 sm:pb-24">
          <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-muted-foreground max-w-2xl mx-auto">
              Simple, fair, and transparent. Here&rsquo;s everything you need to know about our return process.
            </p>
          </div>
        ...
        <div className="mx-auto my-24 max-w-4xl px-6 sm:my-32 lg:px-8">
            <div className="rounded-2xl bg-card p-8 ring-1 ring-border shadow-xl border">
                <h2 className="text-2xl font-bold tracking-tight text-card-foreground text-center">Need Help with a Return?</h2>
                ...
                <div className="mt-8 space-y-5 text-muted-foreground">
                    <div className="flex items-center gap-4">
                      ...
                      <a href="mailto:rachnacollective@gmail.com" className="hover:underline text-primary">rachnacollective@gmail.com</a>
                    </div>
                  </div>
            </div>
        </div>
