...
const shippingSections = [
  ...
  },
  {
    ...
    content: (
      <ul>
        <li>
          MORVILN is not responsible for any customs and taxes applied
          to your order.
        </li>
        <li>
  ...
  },
  {
    ...
    content: (
      <ul>
        <li>
          MORVILN is not liable for products damaged or lost during
          shipping.
        </li>
        <li>
  ...
  },
  {
    ...
    content: (
      <p>
        ...
        for complete information on returns and refunds.
      </p>
    ),
  },
  {
        ...
        <div className="relative isolate overflow-hidden pt-24 pb-16 sm:pt-32 sm:pb-24">
          <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-muted-foreground max-w-2xl mx-auto">
              ...
              what to expect with your MORVILN order.
            </p>
          ...
          <div className="absolute inset-x-0 top-0 -z-10 flex transform-gpu justify-center overflow-hidden blur-3xl">
            <div
              className="aspect-[1500/1036] w-[90rem] flex-none bg-gradient-to-r from-primary/20 to-primary/10 opacity-25"
              style={{
                clipPath:
