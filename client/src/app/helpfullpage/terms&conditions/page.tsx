...
const TermsAndConditions = () => {
  const [openId, setOpenId] = useState<string | null>("overview"); // Keep the overview open by default
      ...
      <main className="flex-grow">
        ...
        <div className="relative isolate overflow-hidden pt-24 pb-16 sm:pt-32 sm:pb-24">
          ...
          <div className="absolute inset-x-0 top-0 -z-10 flex transform-gpu justify-center overflow-hidden blur-3xl">
            <div
              className="aspect-[1500/1036] w-[90rem] flex-none bg-gradient-to-r from-primary/30 to-primary/10 opacity-25"
              style={{
                clipPath:
        ...
        <div className="mx-auto my-24 max-w-4xl px-6 sm:my-32 lg:px-8">
          <div className="rounded-2xl bg-card p-8 ring-1 ring-border shadow-xl shadow-primary/10">
