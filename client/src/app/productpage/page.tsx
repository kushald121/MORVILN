          ...
          <div className="lg:col-span-5 flex flex-col justify-center py-8">
            ...
            <div className="flex flex-col gap-4 mb-12">
              <button
                ...
                className="w-full bg-[#333] hover:bg-[#444] text-white py-4 text-lg font-bold tracking-wider transition-colors"
              >
                ADD TO CART
              </button>
              <button
                ...
                className="w-full bg-[#1a1a1a] hover:bg-[#2a2a2a] text-white py-4 text-lg font-bold tracking-wider transition-colors"
              >
                BUY IT NOW
              </button>
            </div>
            ...
            <div className="py-8 border-t border-gray-800 space-y-8">
              ...
              <div className="space-y-4">
                <h4 className="font-bold uppercase tracking-wide text-gray-300 text-sm">Fabric & Quality</h4>
                <ul className="space-y-3 text-sm text-gray-400">
                  <li className="flex gap-3">
                    <span className="w-1.5 h-1.5 rounded-full bg-white mt-2 flex-shrink-0" />
                    <span><strong className="text-white">100% Premium Biowashed Cotton:</strong> Soft feel and better durability.</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="w-1.5 h-1.5 rounded-full bg-white mt-2 flex-shrink-0" />
                    <span><strong className="text-white">Heavy-weight Brushed Cotton Fleece:</strong> Warmth and a plush interior.</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="w-1.5 h-1.5 rounded-full bg-white mt-2 flex-shrink-0" />
                    <span><strong className="text-white">Baggy Straight Fit:</strong> Relaxed, roomy silhouette.</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="w-1.5 h-1.5 rounded-full bg-white mt-2 flex-shrink-0" />
                    <span><strong className="text-white">Jet Black:</strong> Deep, rich black tone.</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="w-1.5 h-1.5 rounded-full bg-white mt-2 flex-shrink-0" />
                    <span><strong className="text-white">Comfort Features:</strong> Elastic drawstrings for adjustable waist.</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="w-1.5 h-1.5 rounded-full bg-white mt-2 flex-shrink-0" />
                    <span><strong className="text-white">Skin Friendly:</strong> Biowashed, combed, and hypo-allergic.</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="w-1.5 h-1.5 rounded-full bg-white mt-2 flex-shrink-0" />
                    <span><strong className="text-white">Certified:</strong> GOTS organic cotton.</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-[#111] p-4 rounded border border-gray-800">
                <p className="text-xs text-gray-400 uppercase tracking-widest mb-1">Craftsmanship</p>
                <p className="text-sm text-white">
                  Artisan stitched and screen printed. Crafted by human hands for uniqueness.
                </p>
              </div>
            </div>
          </div>
