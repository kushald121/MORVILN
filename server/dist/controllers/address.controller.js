...
const createAddress = async (req, res) => {
    try {
        ...
        const { label, full_name, phone, address_line_1, address_line_2, landmark, city, state, postal_code, country = 'India', is_default = false, } = req.body;
...
const updateAddress = async (req, res) => {
    try {
        ...
        const { label, full_name, phone, address_line_1, address_line_2, landmark, city, state, postal_code, country, is_default, } = req.body;
        // Check if address exists and belongs to user
        const { data: existingAddress } = await database_1.default
            .from('user_addresses')
            .select('*')
            .eq('id', id)
            .eq('user_id', userId)
