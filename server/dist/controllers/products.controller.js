    ...
    async updateProduct(req, res) {
        try {
            ...
            if (updateData.name !== undefined)
                productUpdate.name = updateData.name;
            if (updateData.description !== undefined)
                productUpdate.description = updateData.description;
            if (updateData.short_description !== undefined)
                productUpdate.short_description = updateData.short_description;
            if (updateData.base_price !== undefined)
                productUpdate.base_price = updateData.base_price;
            if (updateData.compare_at_price !== undefined)
                productUpdate.compare_at_price = updateData.compare_at_price;
            if (updateData.cost_price !== undefined)
                productUpdate.cost_price = updateData.cost_price;
            if (updateData.category_id !== undefined)
                productUpdate.category_id = updateData.category_id;
            if (updateData.gender !== undefined)
                productUpdate.gender = updateData.gender;
            if (updateData.tags !== undefined)
                productUpdate.tags = updateData.tags;
            if (updateData.is_featured !== undefined)
                productUpdate.is_featured = updateData.is_featured;
            if (updateData.is_active !== undefined)
                productUpdate.is_active = updateData.is_active;
            if (updateData.seo_title !== undefined)
                productUpdate.seo_title = updateData.seo_title;
            if (updateData.seo_description !== undefined)
                productUpdate.seo_description = updateData.seo_description;
            // If slug is provided, ensure it's unique
            if (updateData.slug !== undefined) {
                const { data: existingProduct } = await supabaseclient_1.default
                    .from('products')
                    .select('id')
