...
# This script tests all email endpoints using curl
...
# Send Test Email (Replace recipient@example.com with a valid email)
...
# Send Order Confirmation (Replace customer@example.com with a valid email)
