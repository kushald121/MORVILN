/**
 * Cart API Test Script with Provided Token
 * 
 * This script tests the cart API endpoints using the provided bearer token.
 */
...
async function testCartAPIWithToken() {
  console.log('🧪 Testing Cart API with Provided Token...\n');
  ...
  try {
    ...
    console.log('\n2️⃣  Testing GET /cart (empty cart)');
    try {
    ...
    // Test 3: Get cart count (should be 0)
    console.log('\n3️⃣  Testing GET /cart/count');
    try {
    ...
    // Test 4: Validate cart (should be valid even when empty)
    console.log('\n4️⃣  Testing GET /cart/validate');
    try {
    ...
    // Test 5: Clear cart (even if empty)
    console.log('\n5️⃣  Testing DELETE /cart (clear cart)');
    try {
